...
function HomePage() {
  ...
  const mockProfiles = [
    { id: 1, name: "Sarah Miller", age: 25, language: "English", location: "London, UK" },
    { id: 2, name: "Carlos Rodriguez", age: 32, language: "Spanish", location: "Madrid, Spain" },
    { id: 3, name: "Priya Patel", age: 29, language: "Hindi", location: "Mumbai, India" },
    { id: 4, name: "James Wilson", age: 35, language: "English", location: "Sydney, Australia" },
    { id: 5, name: "Linh Nguyen", age: 27, language: "Vietnamese", location: "Hanoi, Vietnam" }
  ];
  ...
  return (
    <div className="home-container">
      {/* Left Side - Conversational Onboarding */}
          ...
          <div className="profile-card">
            <div className="profile-header">
              ...
              <div className="profile-info">
                ...
                <p>{mockProfile.age} years old</p>
              </div>
            </div>
            <div className="profile-details">
              <div className="detail-item">
                <span className="detail-label">Language:</span>
                <span className="detail-value">{mockProfile.language}</span>
              </div>
              <div className="detail-item">
                <span className="detail-label">Location:</span>
                <span className="detail-value">{mockProfile.location}</span>
              </div>
              <div className="detail-item bio">
                <span className="detail-label">Bio:</span>
                <p className="detail-value">{mockProfile.bio}</p>
              </div>
            </div>
          </div>
        ) : (
